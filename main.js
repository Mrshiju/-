...
//纪念日
let startDay = "2014/10/1";
//当地拼音,需要在下面的墨迹天气url确认
const local = "beijing/beijing/fengtai-district";

//发送者邮箱厂家
let EmianService = "163";
//发送者邮箱账户SMTP授权码
let EamilAuth = {
  user: "wshijuwang@163.com",
  pass: "zlp521"
};
//发送者昵称与邮箱地址
// let EmailFrom = '"Mr.shiju" <wshijuwang@163.com>';
let EmailFrom = 'wshijuwang@163.com';

//接收者邮箱地
let EmailTo = "1874730511@qq.com,fuweiran2060@163.com,852672895@qq.com,xinran9063@126.com,1178316016@qq.com";
//邮件主题
let EmailSubject = "暖暖的小邮件";
